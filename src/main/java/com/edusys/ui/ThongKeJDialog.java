...
public class ThongKeJDialog extends javax.swing.JDialog {
                        ...
                        .addGroup(pnlKhachHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlKhachHangLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlKhachHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(pnlKhachHangLayout.createSequentialGroup()
                                        .addComponent(lblThang1, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                ...
                .addGroup(pnlGiaoDichLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlGiaoDichLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlGiaoDichLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlGiaoDichLayout.createSequentialGroup()
                                .addComponent(lblThang2, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(pnlTaiKhoanLayout.createSequentialGroup()
                .addGroup(pnlTaiKhoanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlTaiKhoanLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlTaiKhoanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlTaiKhoanLayout.createSequentialGroup()
                                .addComponent(lblThang3, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(pnlVayTienLayout.createSequentialGroup()
                .addGroup(pnlVayTienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlVayTienLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlVayTienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlVayTienLayout.createSequentialGroup()
                                .addGroup(pnlVayTienLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(lblThongKeVayTien)
                                    .addGroup(pnlVayTienLayout.createSequentialGroup()
                                        .addComponent(lblThang4, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnExportExcelKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelKHActionPerformed
        ...
        String filePath = "ThongKeKhachHang_" + System.currentTimeMillis() + ".xlsx";
        try {
            ExcelExporter.exportToExcel(tblThongKeKhachHang, filePath);
        } catch (IOException e) {
    ...
    private void btnExportExcelGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelGDActionPerformed
        // TODO add your handling code here:
        if (tblThongKeGiaoDich.getRowCount() == 0) {
            MsgBox.alert(this, "Không có dữ liệu để xuất!");
            return;
        }
        String filePath = "ThongKeGiaoDich_" + System.currentTimeMillis() + ".xlsx";
        try {
            ExcelExporter.exportToExcel(tblThongKeGiaoDich, filePath);
        } catch (IOException e) {
            MsgBox.alert(this, "Lỗi khi xuất file Excel: " + e.getMessage());
        }
    ...
    private void btnExportExcelTKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelTKActionPerformed
        // TODO add your handling code here:
        if (tblThongKeTaiKhoan.getRowCount() == 0) {
            MsgBox.alert(this, "Không có dữ liệu để xuất!");
            return;
        }
        String filePath = "ThongKeTaiKhoan_" + System.currentTimeMillis() + ".xlsx";
        try {
            ExcelExporter.exportToExcel(tblThongKeTaiKhoan, filePath);
        } catch (IOException e) {
            MsgBox.alert(this, "Lỗi khi xuất file Excel: " + e.getMessage());
        }
    ...
    private void btnExportExcelVTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelVTActionPerformed
        // TODO add your handling code here:
       if (tblThongKeVayTien.getRowCount() == 0) {
            MsgBox.alert(this, "Không có dữ liệu để xuất!");
            return;
        }
        String filePath = "ThongKeVayTien_" + System.currentTimeMillis() + ".xlsx";
        try {
            ExcelExporter.exportToExcel(tblThongKeVayTien, filePath);
        } catch (IOException e) {
            MsgBox.alert(this, "Lỗi khi xuất file Excel: " + e.getMessage());
        }
    ...
    void fillComboBoxNamKH() {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cboNamKH.getModel();
    ...
    void fillTableKhachHang() {
        ...
        try {
            int nam = Integer.parseInt(cboNamKH.getSelectedItem().toString());
            String thangStr = cboThangKH.getSelectedItem().toString().trim();
            if (thangStr.isEmpty()) return; // Không lọc nếu tháng trống
            int thang = Integer.parseInt(thangStr);
            List<Object[]> list = dao.getThongKeKhachHang(thang, nam);
            for (Object[] row : list) {
                // Format ngày sinh và ngày tạo nếu có
                if (row[2] != null) row[2] = sdf.format(row[2]); // Ngày sinh
                if (row[10] != null) row[10] = sdf.format(row[10]); // Ngày tạo
                model.addRow(row);
            }
        } catch (NumberFormatException e) {
            MsgBox.alert(this, "Vui lòng chọn tháng và năm hợp lệ!");
        }
    }

    void fillComboBoxNamGD() {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cboNamGD.getModel();
        model.removeAllElements();
    ...
    void fillTableGiaoDich() {
        ...
        try {
            int nam = Integer.parseInt(cboNamGD.getSelectedItem().toString());
            String thangStr = cboThangGD.getSelectedItem().toString().trim();
            if (thangStr.isEmpty()) return;
            int thang = Integer.parseInt(thangStr);
            List<Object[]> list = dao.getThongKeGiaoDich(thang, nam);
            for (Object[] row : list) {
                if (row[3] != null) row[3] = sdf.format(row[3]); // Ngày giao dịch
                model.addRow(row);
            }
        } catch (NumberFormatException e) {
            MsgBox.alert(this, "Vui lòng chọn tháng và năm hợp lệ!");
    ...
    void fillComboBoxNamTK() {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cboNamTK.getModel();
        model.removeAllElements();
    ...
    void fillTableTaiKhoan() {
        ...
        try {
            int nam = Integer.parseInt(cboNamTK.getSelectedItem().toString());
            String thangStr = cboThangTK.getSelectedItem().toString().trim();
            if (thangStr.isEmpty()) return;
            int thang = Integer.parseInt(thangStr);
            List<Object[]> list = dao.getThongKeTaiKhoan(thang, nam);
            for (Object[] row : list) {
                if (row[4] != null) row[4] = sdf.format(row[4]); // Ngày mở
                model.addRow(row);
            }
        } catch (NumberFormatException e) {
            MsgBox.alert(this, "Vui lòng chọn tháng và năm hợp lệ!");
    ...
    void fillComboBoxNamVT() {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cboNamVT.getModel();
        model.removeAllElements();
    ...
    void fillTableVayTien() {
        ...
        try {
            int nam = Integer.parseInt(cboNamVT.getSelectedItem().toString());
            String thangStr = cboThangVT.getSelectedItem().toString().trim();
            if (thangStr.isEmpty()) return;
            int thang = Integer.parseInt(thangStr);
            List<Object[]> list = dao.getThongKeVayTien(thang, nam);
            for (Object[] row : list) {
                if (row[6] != null) row[6] = sdf.format(row[6]); // Ngày vay
                model.addRow(row);
            }
        } catch (NumberFormatException e) {
            MsgBox.alert(this, "Vui lòng chọn tháng và năm hợp lệ!");
